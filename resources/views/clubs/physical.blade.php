...
@section('title', 'Optic Clubs - Physical Clubs')
...
@endif
    ...
    <style>
        #bannerdi {
            background: linear-gradient(rgba(0,0,0,0.5), #128b9e94), url('{{ asset('images/physical.jpg') }}');
    ...
    <div class="club-list">
        <h1 style="display: flex; justify-content: center;font-family: Arial, sans-serif; font-weight: bold; font-size: 2.5rem; margin-top: 40px; margin-bottom: 20px; color:rgb(255, 255, 255);">
            Physical Clubs
        </h1>
        
        <div class="search-container" style="text-align: center; margin-bottom: 20px;">
            <form action="{{ route('clubs.physical') }}" method="GET" style="display: flex; justify-content: center; align-items: center; gap: 10px;">
